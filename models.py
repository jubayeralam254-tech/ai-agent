...
from sqlalchemy import String, ForeignKey, DateTime, Integer, Text, ARRAY, Float
...
class DocumentChunk(Base):
    ...
    # Temporarily using ARRAY(Float) so you can run the app locally without pgvector on Windows.
    # In production (Render/Docker), this should be switched back to Vector(768).
